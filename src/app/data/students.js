...
export const DATA_ORIGIN   = "afgang-e20-2021-01-08-AK.xlsx"
export const DATA_PARSEDATE = "Fri Jan 08 2021"
export const DATA_STUDENTS = [
  {
    ...
    "name": "Tonje Madsen",
    "theme": "2",
    "title": "'Arkopolis-høyden' - En radikal transformasjon av et kulturelt landemerke i Stavanger",
    "email": "tonjemadsenb@gmail.com",
    "text": "Avgangsprosjektet tar utgangspunkt i en transformasjon og addisjon av det som i dag utgjør Stavanger Museum. Bygningen rommer i dag kulturhistorisk avdeling, en zoologisk samling og et barnemuseum.<br /><br />Prosjektet omhandler problematikken som oppstår når bygninger som har en verdi i historisk kontekst, mister deres aktualitet og funksjon på grunn av behovsendringer i nåtiden. Prosjektets søker å gi et bud på hvordan tilført arkitektur kan bidra til å gjøre den ikke-relevante arkitekturen, relevant.",
    "stub": "tonje-madsen"
  },
  {
    "id": "16875",
  ...
  },
  {
    ...
    "name": "Julie Holk",
    "theme": "1",
    "title": "Interaktion til Motivation - Et ressourcestærkt fællesskab",
    "email": "julieholk@live.dk",
    "text": "Med titlen Interaktion til Motivation - Et ressourcestærkt fællesskab, arbejder mit projekt i kontrasterne mellem en voksende ældre generation og byens pulserende liv. Med andre ord udfordrer jeg den gængse forståelse af en pensionisttilværelse som noget der leves horisontalt.",
    "stub": "julie-holk"
  },
  {
    "id": "16871",
  ...
  },
  {
    ...
    "theme": "1",
    "title": "Tættere på naturen: Højskolen som mødested og mulighedsrum",
    "email": "thorlakk@gmail.com",
    "text": "Projektet undersøger potentialerne i at etablere en højskole i Søhøjlandets varierede natur med naturen selv som omdrejningspunkt.\r\nMed udgangspunkt i aktivitetsbaseret læring, danner højskolen de fysiske rammer for elevernes møde med naturen.",
  ...
  },
  {
    ...
    "theme": "1",
    "title": "FRA VÆRESTED TIL MØDESTED - a new frontier for socially vulnerable in Aarhus",
  ...
  },
  {
    ...
    "text": "Transformation af Aalborg Universitetshospital Nord. Projektet omhandler integreringen af den nye bydel til resten af byen og fokuserer på at bevare den historiske karakter.",
  ...
  },
  {
    ...
    "theme": "1",
    "title": "Perception in the absence of vision  ·  Rehabilitation for the visually impaired",
